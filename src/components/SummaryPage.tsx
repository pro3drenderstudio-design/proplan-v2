        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          {!rendersTriggered && (PHASES.some(p => !!phaseScreenshots[p.id]) || !!interior2Screenshot) && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-xl text-[11px] font-semibold uppercase tracking-widest transition-all hover:opacity-90 active:scale-95"
