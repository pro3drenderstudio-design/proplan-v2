...
const NAV_CONFIG_ALL = [
  { href: "/admin/plans",    label: "Plan Config", icon: PlansIcon, roles: ["super_admin","manager"] },
...
const TOOLS_ALL = [
  ...
  { href: "/admin/glb-compressor",   label: "GLB Compressor",   icon: GlbIcon,      roles: ["super_admin","manager","editor","artist"] },
  { href: "/admin/outreach",         label: "Cold Outreach",    icon: MailIcon,     roles: ["super_admin","manager"] },
  { href: "/admin/linkedin",         label: "LinkedIn Studio",  icon: LinkedInIcon, roles: ["super_admin"] },
];
